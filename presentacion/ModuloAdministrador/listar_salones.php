                ...
                if (data["response"] == 1) {
                    ...
                    $('#tablal').DataTable({
                        ...
                        language: {
                            ...
                            infoEmpty: "Mostrando contactos del 0 al 0 de un total de 0 salones",
                ...
                if (data["response"] == 1) {
                    ...
                    $('#tablal').DataTable({
                        ...
                        language: {
                            ...
                            searchPlaceholder: "Búsqueda Detallada",
                            lengthMenu: "Mostrar _MENU_ registros",
                            info: "Mostrando contactos del _START_ al _END_ de un total de _TOTAL_ contactos",
                            infoEmpty: "Mostrando contactos del 0 al 0 de un total de 0 contactos",
                            infoFiltered: "(filtrado de un total de _MAX_ registros)",
                            infoPostFix: "",
                            loadingRecords: "Cargando...",
                            zeroRecords: "No se encontraron resultados",
